...
const projectRecords: ProjectRecord[] = [
  ...
  },
  {
    ...
    constraints: ["向省分业务和内部系统提供标准化支付接口", "通过渠道适配层屏蔽各支付渠道的交易、环境与接口差异", "将渠道账单、平台交易流水、匹配规则、差异状态和操作审计纳入统一管理"],
    decisions: [
      ...
      { title: "对账平台", detail: "独立设计对账平台，支持导入渠道 CSV 账单，按支付单号优先、通道流水辅助匹配平台交易；将本地单边、渠道单边、金额不符和状态不符等差异纳入待处理、处理中、已解决的状态流转。" },
    ],
    outcome: ["完成沃支付、微信和支付宝三渠道动态收银，以及支付、退款、撤销、查询和导出的完整交易链路", "完成运营人员、商户运营员和管理员的角色隔离，覆盖交易、报表、对账差异与操作审计", "完成渠道 CSV 账单导入、独立对账批次、差异状态流转与 UAT 验证，形成可演示的支付与对账闭环"],
