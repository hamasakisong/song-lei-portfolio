  ...
  return (
    <article className="about-page">
      ...
      <div className="container about-grid">
        ...
        <Reveal delay={.08}><p className="eyebrow">能力</p><div className="skill-cloud">{profile.skills.map((skill) => <span key={skill}>{skill}</span>)}</div><p className="certificate">PMP 项目管理认证 · 太原理工大学 · 计算机科学与技术本科</p></Reveal>
      </div>
    </article>
  );
}
